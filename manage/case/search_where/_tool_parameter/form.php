...
$id = $this->row['Id'];
$all = db::all("select * from wb_case_search_where_extid where wb_case_search_where_id='{$id}' order by MyOrder asc,Id asc");
...
<div class='_dbs_item <?=$cfg['Class']?>' data-dbs-type='<?=strtolower($cfg['Type'])?>'>
	...
	<div id="No000" class='_dbs_content'>
		...
		<table class="PSearch_table ly_table_list maxw">
			...
			<tbody ly-drag-sort fn="case_search_tool_parameter">
			</tbody>
		</table>
