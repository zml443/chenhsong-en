...
$.task.push(function () {
	_('[liquid=1],[liquid=2],[liquid=3]').each(function () {
		var a = $(this);
		var l = a.attr('liquid');
		if (l=='2') {
			$.__liquid_distortion({
				obj: $(this),
				displacementImage: $.path+'web/pixi/img/clouds2.jpg',
				autoPlay: true,
			...
			$.__liquid_distortion({
				obj: $(this),
				displacementImage: $.path+'web/pixi/img/crystalize.jpg',
				autoPlay: false,
			...
			$.__liquid_distortion({
				obj: $(this),
				displacementImage: $.path+'web/pixi/img/clouds.jpg',
				autoPlay: true,
				autoPlaySpeed: [10, 3],
...
$.__liquid_distortion = function( options ) {
