...
$.fn.autoMove = function(args){
	...
	that.find("[is-close]").click(function(){
		clearTimeout(mvtid);
		that.remove();
	})
	});
...
$('[tip-fload]').each(function () {
	var a = $(this);
	a.css({'display':'inline-block', 'z-index':'9999999', height:a.innerHeight()});
	a.autoMove({speed:parseInt(a.attr('data-speed')||120)});
});