			...
			'<tr>' +
				...
				'<td td2>' +
					...
					'<div input class="path-inp relative">' +
						...
						'<div class="img-upload pointer" file-selector="manage" fn="WP.$.__file_selector_style.add_img">选择</div>' +
					'</div>' +
				'</td>' +
			'</tr>'
		,
			...
			if (jso[i].Type.search(/textarea/i) >= 0) {
				...
				inp +=
					'<div input class="path-inp relative">' +
						...
						'<div class="img-upload" file-selector="manage" pointer fn="WP.$.__file_selector_style.add_img">选择</div>' +
					'</div>'
				;
			}
