$('[jextstyle]').append("[canvas-src^='dot4,']{background-color: #214;}");
$.task.push(function(){
    _('[canvas-src^="dot4,"]').each(function () {
        var thi = $(this);
        ...
        var mouse, originx, originy, int, cvs, canvas;
