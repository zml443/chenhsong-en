...
<script>
	var path_url=window.document.location.pathname;
	var url=path_url.substring(0,path_url.substr(1).indexOf('/')+1);
</script>
<script>var _this_path = '/api/pay/alipay';</script>
...
<script>
    if (location.hash.indexOf('error') != -1) {
        ...
        if (ua.indexOf('micromessenger') != -1) {
            ...
            location.href = param != '' ? _AP.decode(param) : '/pay-error.html';
        }
    }
</script>
</body>
